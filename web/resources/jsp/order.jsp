    ...
    <div class="parent">
        <div class="block">
            <form action="order" method="post" enctype="multipart/form-data">
                ...
                <input type="text" name="requisites" id="requisites" pattern="[A-Za-z0-9_]{2,25}" required
                       title="Use latin and numbers, (5-15)"/>

                <label for="address">Adress</label>
                <input type="text" name="address" id="address" pattern="[A-Za-z0-9_]{2,25}" required
                       title="Use latin and numbers, (5-15)"/>

                <br><br>
                <input type="radio" class="checkbox" id="checkbox" name="deliveryType" value="MasterCard" />
                <label for="checkbox">MasterCard</label>

                <br><br>
                <input type="radio" class="checkbox" id="checkbox3" name="deliveryType" value="Visa"/>
                <label for="checkbox3">Visa</label>
                <br>
